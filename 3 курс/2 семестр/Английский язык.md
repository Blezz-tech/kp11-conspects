...
4. The next step is to design a plan of instructions in flowchart – a diagram show how the computer works though the program.
5. Next, write the instructions in a programming language. (called source code)
6. Then use a compiler, a program that converts the source code into machine code.
