...
1. Programming is the process of writing a program using a particular programming language.
2. We normally follow these steps:
3. First of all, understand the problem and plan a solution.
4. The next step is to design a plan of instructions in the form of a flowchart – a diagram that uses special symbols to show how the computer works through the program.
5. Next, write the instructions in a programming language. These computer instructions are called source code.
6. Then use a compiler, a special program that converts the source code into machine code(binary code) – the only language understood by the processor.
7. Once you’ve written the program, test it with sample data to see if there are any errors or bugs. This process is called debugging.
8. Finally, write program documentation – a detailed description how to use the program.
