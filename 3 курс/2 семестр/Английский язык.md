...
| Language     | Associated <br> language | Type of language             | Use                                            |
| ------------ | ------------------------ | ---------------------------- | ---------------------------------------------- |
| C++          | C                        | programing                   | general and <br> systems <br> programming      |
| HTML         |                          | page <br> description        | Creating web <br> pages                        |
| Java         | C                        | programming                  | programs and <br> small electronic <br> device |
| JavaScript   | Java                     | scripting                    | webpages                                       |
| Visual Basic | Basic                    | programming <br> environment | general purpose <br> apps                      |
| Delphi       | Pascal                   | programming <br> environment | general purpose <br> programs                  |
...
2. JavaScript
3. C++
4. able to run on many architectures and operating systems
5. HTML
6. Hyper Text Markup Language
7. Delphi, Visual Basic
8. HTML
