...
#### Вычисление благоприятных для $n_1$

```python
import math 

def func_c(n: int, i: int):
    return math.factorial(n) / (math.factorial(n - i) * math.factorial(i))


x1 = 2 ** 12 - func_c(12, 0) - func_c(12, 1)

print(x1)

x2 = 0

for i2 in range(2, 12 + 1):
    C1 = func_c(12, i2)
    x2 = x2 + C1
...
#### Вычисление благоприятных для $n_2$
...
x1 = 2 ** 18 - func_c(18, 0) - func_c(18, 1) - func_c(18, 2)

print(x1)

x2 = 0

for i2 in range(3, 18 + 1):
    C1 = func_c(18, i2)
    x2 = x2 + C1
...
#### Нахождение вероятности $P_1$ и $P_2$
...
```bash
python script.py
P1:  0.000001875704306
P2:  0.000000002579481
P1 > P2
```
