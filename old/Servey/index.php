    ...
    <form action="./added.php" method="post">
      ...
      <div class="row">
        <div class="mb-3 mb-3 col-12 col-md-6">
          ...
          <input type="text" name="name" class="form-control" id="form-name" aria-describedby="nameHelp" placeholder="Firstname Lastname" required>
        </div>
        <div class="mb-3 mb-3 col-12 col-md-6">
          <label for="form-email" class="form-label">Email:</label>
          <input type="email" name="email" class="form-control" id="form-email" aria-describedby="emailHelp" placeholder="username@domain.com" required>
        </div>
      </div>
      <div class="row">
        <div class="mb-3 mb-3 col-12 col-md-9">
          <label for="form-address" class="form-label">Address:</label>
          <input type="text" name="address" class="form-control" id="form-address" aria-describedby="addressHelp" placeholder="123 Street Name" required>
        </div>
        <div class="mb-3 mb-3 col-12 col-md-3">
          <label for="form-floor" class="form-label">Apartment or floor:</label>
          <input type="text" name="floor" class="form-control" id="form-floor" aria-describedby="emailHelp" placeholder="B3, 4th Floor, or similar" required>
        </div>
      </div>
      <div class="row">
        <div class="mb-3 mb-3 col-12 col-md-6">
          <label for="form-city" class="form-label">City:</label>
          <input type="text" name="city" class="form-control" id="form-city" aria-describedby="cityHelp" placeholder="City" required>
        </div>
        <div class="mb-3 mb-3 col-12 col-md-3">
          <label for="form-zip" class="form-label">Zip:</label>
          <input type="text" name="floor" class="form-control" id="form-zip" aria-describedby="Help" placeholder="123" required>
        </div>
        <div class="mb-3 mb-3 col-12 col-md-3">
          <label for="form-country" class="form-label">Country:</label>
          <select class="form-select" id="form-country" aria-label="- Select Country -" name="country" required>
        ...
        <div class="row">
          ...
          <div class="mb-3 col-12 col-md-6">
            <div class="btn-group d-flex mb-3">
              <?php foreach (array_fill(0, 5, $question) as $key => $cell) : ?>
                <input type="radio" class="btn-check" name="q<?= $question ?>" value="<?= $key + 1 ?>" id="q<?= $question ?>r<?= $key + 1 ?>" autocomplete="off" required/>
                <label class="btn btn-outline-secondary" for="q<?= $question ?>r<?= $key + 1 ?>"><?= $key + 1 ?></label>
              <?php endforeach ?>

              <input type="radio" class="btn-check" name="q<?= $question ?>" id="q<?= $question ?>r6" autocomplete="off" required/>
        ...
        <div class="row">
          ...
          <div class="mb-3 col-12 col-md-6">
            <div class="mb-3 d-flex gap-3">
              ...
              <input type="range" class="form-range" min="1" max="5" step="1" name="q<?= $question ?>" id="q<?= $question ?>" required>
