...
function getQuantityElemetElements(heightElement) {
...
function startGame() {
    ...
    for (let i = 0; i < getQuantityElemetElements(100); i++) {
    ...
    for (let i = 0; i < getQuantityElemetElements(100 * setting.traffic); i++) {
